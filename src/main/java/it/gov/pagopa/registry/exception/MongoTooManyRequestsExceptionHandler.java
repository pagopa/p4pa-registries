package it.gov.pagopa.registry.exception;

import it.gov.pagopa.registry.dto.generated.ErrorDTO;
...
public class MongoTooManyRequestsExceptionHandler {
  ...
  private ResponseEntity<ErrorDTO> handleRequestRateTooLargeException(Exception ex, HttpServletRequest request, Long retryAfterMs) {
