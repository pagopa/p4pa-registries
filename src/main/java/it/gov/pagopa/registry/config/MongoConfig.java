package it.gov.pagopa.registry.config;

import it.gov.pagopa.registry.utils.Constants;
...
@Configuration
@EnableMongoRepositories(basePackages = "it.gov.pagopa.registry.repository")
